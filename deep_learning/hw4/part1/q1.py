...
def main(data_dir=".", data_limit=None, do_normalize=True):
...
if __name__ == "__main__":
    main(data_limit=250, do_normalize=True)  # {'loss': 1.311, 'acc': 0.684}
    main(data_limit=250, do_normalize=False)  # {'loss': 2.589, 'acc': 0.44}
